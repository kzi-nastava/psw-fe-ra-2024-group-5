...
import { PublishedTourComponent } from 'src/app/feature-modules/tour-authoring/published-tour/published-tour.component';
...
const routes: Routes = [
  ...
  {path: 'published-tours', component: PublishedTourComponent}
];
